  ...
  <div class="container-fluid semi-fluid">
    <div class="row">
      ...
      <div class="col-md-6 col-xs-12 product-slider mb-60">
        ...
        <div class="flickity flickity-slider-wrap mfp-hover" id="gallery-main">
          ...
          <div class="gallery-cell">
            <a href="{{ asset('img/shop/item_lg_1.jpg') }}" class="lightbox-img">
              <img src="{{ asset('img/shop/item_lg_1.jpg') }}" alt="" />
              <i class="ui-zoom zoom-icon"></i>
            </a>
          </div>
          <div class="gallery-cell">
            <a href="{{ asset('img/shop/item_lg_2.jpg') }}" class="lightbox-img">
              <img src="{{ asset('img/shop/item_lg_2.jpg') }}" alt="" />
              <i class="ui-zoom zoom-icon"></i>
            </a>
          </div>
          <div class="gallery-cell">
            <a href="{{ asset('img/shop/item_lg_3.jpg') }}" class="lightbox-img">
              <img src="{{ asset('img/shop/item_lg_3.jpg') }}" alt="" />
              <i class="ui-zoom zoom-icon"></i>
            </a>
          </div>
          <div class="gallery-cell">
            <a href="{{ asset('img/shop/item_lg_4.jpg') }}" class="lightbox-img">
              <img src="{{ asset('img/shop/item_lg_4.jpg') }}" alt="" />
              <i class="ui-zoom zoom-icon"></i>
            </a>
          </div>
          <div class="gallery-cell">
            <a href="{{ asset('img/shop/item_lg_5.jpg') }}" class="lightbox-img">
              <img src="{{ asset('img/shop/item_lg_5.jpg') }}" alt="" />
              <i class="ui-zoom zoom-icon"></i>
            </a>
          </div>
        ...
        <div class="gallery-thumbs">
          <div class="gallery-cell">
            <img src="{{ asset('img/shop/item_thumb_1.jpg') }}" alt="" />
          </div>
          <div class="gallery-cell">
            <img src="{{ asset('img/shop/item_thumb_2.jpg') }}" alt="" />
          </div>
          <div class="gallery-cell">
            <img src="{{ asset('img/shop/item_thumb_3.jpg') }}" alt="" />
          </div>
          <div class="gallery-cell">
            <img src="{{ asset('img/shop/item_thumb_4.jpg') }}" alt="" />
          </div>
          <div class="gallery-cell">
            <img src="{{ asset('img/shop/item_thumb_5.jpg') }}" alt="" />
          </div>
      ...
      <div class="col-md-6 col-xs-12 product-description-wrap">
        ...
        <span class="price">
          <del>
            <span>R$ {{ number_format($p->preco + ($p->preco * 20 / 100),2,'.',',') }}</span>
          </del>
          <ins>
        ...
        <p class="short-description">Our Shop is a very slick and clean e-Our.</p>
        ...
        <div class="product-actions">
          ...
          <a href="#" class="btn btn-dark btn-lg add-to-cart"><span>Add ao Carrinho</span></a>
        ...
        <div class="product_meta">
          <span class="sku">Cod: <a href="#">{{ $p->id }}</a></span>
          <span class="brand_as">Categoria: <a href="#">Men T-shirt</a></span>
          <span class="posted_in">Tags: <a href="#">{{ $p->tag }}</a></span>                
        </div>
        ...
        <div class="panel-group accordion mb-50" id="accordion">
          <div class="panel">
            <div class="panel-heading">
              <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="minus">Descrição<span>&nbsp;</span>
              </a>
            </div>
        ...
        <div class="product">
          <div class="product-item hover-trigger">
            <div class="product-img">
              <a href="{{ route('catalogo.show',$pr->slug) }}">
                <img src="{{ asset('img/shop/shop_item_3.jpg') }}" alt="{{ $pr->slug }}.jpg">
                <img src="{{ asset('img/shop/shop_item_back_3.jpg') }}" alt="{{ $pr->slug }}.jpg" class="back-img">
              </a>
              <div class="product-label">
                <span class="sale">Indisponivel</span>
              </div>
              <div class="hover-2">                    
                <div class="product-actions">
              ...
              <a href="{{ route('catalogo.show',$pr->slug) }}" target="_blank" class="product-quickview">Ver mais</a>
            </div>
            <div class="product-details">                      
              <h3 class="product-title">
                <a href="{{ route('catalogo.show',$pr->slug) }}">{{ $pr->titulo }}</a>
              </h3>
              <span class="category">
            ...
            <span class="price">
              <del>
                <span>R$ {{ number_format($pr->preco + ($pr->preco * 20 / 100),2,'.',',') }}</span>
              </del>
              <ins>
                <span class="amount">R$ {{ number_format($pr->preco,2,'.',',') }}</span>
              </ins>
            </span>
          </div>
        </div>
